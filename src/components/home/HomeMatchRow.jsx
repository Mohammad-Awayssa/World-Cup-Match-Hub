  ...
  return (
    <article className={`match-row grid items-center gap-3 px-4 py-4 sm:px-6 ${compact ? 'lg:grid-cols-[150px_1fr_150px_24px]' : 'lg:grid-cols-[120px_1fr_180px]'}`}>
      <div className="border-white/10 lg:border-r">
        <strong className="block text-sm font-bold text-white">{formatLocalTime(match.kickoffUTC)}</strong>
      ...
      <div className="grid grid-cols-[1fr_auto_1fr] items-center gap-2 sm:gap-3">
        ...
        <span className="font-heading px-1 text-sm font-black text-neon sm:px-2 sm:text-base">VS</span>
