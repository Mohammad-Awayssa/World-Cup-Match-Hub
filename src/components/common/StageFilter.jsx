...
export function StageFilter({ value, onChange }) {
  return (
    <select value={value} onChange={(event) => onChange(event.target.value)} className="h-12 rounded-xl border border-white/10 bg-[#101027] px-4 text-sm text-white focus:border-gold/50 focus:outline-none">
