  ...
  return (
    <label className="relative block flex-1">
      ...
      <input
        ...
        className="h-12 w-full rounded-xl border border-white/10 bg-white/5 pl-11 pr-11 text-sm text-white placeholder:text-text-muted focus:border-gold/50 focus:outline-none"
      />
      {value && (
